...
def generateRandomTidAndInsert(pid_quantity_list):  #generateRandomTidAndInsert
    t_id = str(uuid.uuid4())
...
def fetchQuantity(product_id_to_query, transaction_id_to_query):
...
def deleteTransaction(transaction_id_to_delete):
